...
def main():
    ...
    # used for packing all 100 content.json files into a folder
    ...
    for i in range(100):
        ...
        with open(f"contents/content{i+1}.json", "w") as f:
            json.dump(data, f, indent=4, separators=(',', ': '))
            
    print("100 content.json files successfully created!")
